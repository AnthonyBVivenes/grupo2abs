...
class Deck:
    ...
    def generate_dobble_deck(self):
        ...
        - q = 7 (primo)
        - Puntos: clases de equivalencia de (x,y,z) ∈ GF(7)³ \ {(0,0,0)} / ~
        - Rectas: clases de equivalencia de [a,b,c] ∈ GF(7)³ \ {(0,0,0)} / ~
        ...
        # Crear objetos Card
        self.cards = [Card(i, symbols) for i, symbols in enumerate(cards_symbols)]
